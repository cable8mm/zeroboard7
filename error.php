 ...
 **************************************************************************/
    ...
    if ($member[is_admin] >= 3 && !eregi($no . ',', $member[board_name])) {
        error('게시판 설정을 변경할 권한이 없습니다');
    }
...
<table border=0 cellspacing=1 cellpadding=0 width=100% bgcolor=#b0b0b0>
  ...
  <tr height=30 bgcolor=white>
    <td align=right colspan=8 style=font-family:Tahoma;font-size:8pt;>
      그룹이름 : <b><?=$group_data[name]?></b> , 게시판 이름 : <b><a
          href=zboard.php?id=<?=$data[name]?> target=_blank><?=$data[name]?></a></b> &nbsp;&nbsp;&nbsp;
      <input type=button value='카테고리관리' class=input style=width=100px
        onclick=location.href="<?=$PHP_SELF?>?exec=view_board&group_no=<?=$group_no?>&exec2=category&no=<?=$no?>&page=<?=$page?>&page_num=<?=$page_num?>">
      <input type=button value='권한설정' class=input style=width=100px
        onclick=location.href="<?=$PHP_SELF?>?exec=view_board&group_no=<?=$group_no?>&exec2=grant&no=<?=$no?>&page=<?=$page?>&page_num=<?=$page_num?>">
  ...
  <form method=post action=<?=$PHP_SELF?> name=write onsubmit="return
    check_submit();">
...
?>
    ...
    <tr height=70 bgcolor=#e0e0e0>
      ...
      <td>&nbsp;&nbsp;
        ...
        <input type=checkbox name=only_board value=1 <?=$check[1]?>>
        게시판으로만 사용시 선택하여 주십시요. (스킨처리 속도가 줄어듭니다)<br>
        &nbsp;&nbsp; <input type=button class=input onclick=check1() style=border-color:#b0b0b0;height=18px
          value="게시판 형태"> 내용이 목록에 나오지 않는 게시판 형태의 스킨
        <br>
        <img src=images/t.gif border=0 height=4><br>&nbsp;&nbsp;
        <input type=button class=input onclick=check2() style=border-color:#b0b0b0;height=18px value="방명록 형태"> 내용이 목록에
        나오는 방명록 형태의 스킨
      </td>
    </tr>
    ...
    <tr height=25 bgcolor=#e0e0e0>
      ...
      <td>&nbsp;&nbsp;
        <input type=text name=bg_image
          value='<?php echo $data[bg_image];?>' size=50 maxlength=255
          class=input style=width:95%;border-color:#b0b0b0>
      </td>
    </tr>
    ...
    <tr height=25 bgcolor=#e0e0e0>
      ...
      <td>&nbsp;&nbsp;
        <input type=text name=bg_color
          value='<?php echo $data[bg_color];?>' size=20 maxlength=255
          class=input style=border-color:#b0b0b0> &nbsp;&nbsp;
      </td>
    </tr>
    ...
    <tr height=25 bgcolor=#e0e0e0>
      ...
      <td>&nbsp;&nbsp;
        <input type=text name=table_width
          value='<?php echo $data[table_width];?>' size=4 maxlength=4
          class=input style=border-color:#b0b0b0> &nbsp;&nbsp;
    ...
    <tr height=25 bgcolor=#e0e0e0>
      ...
      <td>&nbsp;&nbsp;
        <input type=text name=cut_length
          value='<?php echo $data[cut_length];?>' size=11
          maxlength=11 class=input style=border-color:#b0b0b0> &nbsp;&nbsp;
    ...
    <tr height=25 bgcolor=#e0e0e0>
      ...
      <td>&nbsp;&nbsp;
        <input type=text name=memo_num
          value='<?php echo $data[memo_num];?>' size=3 maxlength=3
          class=input style=border-color:#b0b0b0> &nbsp;&nbsp;
    ...
    <tr height=25 bgcolor=#e0e0e0>
      ...
      <td>&nbsp;&nbsp;
        <input type=text name=page_num
          value='<?php echo $data[page_num];?>' size=3 maxlength=3
          class=input style=border-color:#b0b0b0> &nbsp;&nbsp;
    ...
    <tr height=25 bgcolor=#e0e0e0>
      ...
      <td height=40>&nbsp;&nbsp;
        <input type=text name=title
          value='<?php echo stripslashes($data[title]);?>' size=20
          maxlength=250 class=input style=width:95%;border-color:#b0b0b0><br>
        &nbsp;&nbsp; 브라우저 상단의 타이틀을 지정
      </td>
    </tr>
    ...
    <tr height=25 bgcolor=#e0e0e0>
      ...
      <td>&nbsp;&nbsp; <input type=text name=header_url
          value='<?php echo $data[header_url];?>' size=40
          maxlength=255 class=input style=width:95%;border-color:#b0b0b0>
      </td>
    </tr>
    ...
    <tr height=25 bgcolor=#e0e0e0>
      ...
      <td>&nbsp;&nbsp;
        <textarea name=header cols=70 rows=10 class=textarea
          style=width:95%;border-color:b0b0b0><?php echo stripslashes($data[header]);?></textarea>
      </td>
    </tr>
    ...
    <tr height=25 bgcolor=#e0e0e0>
      ...
      <td>&nbsp;&nbsp;
        <input type=text name=footer_url
          value='<?php echo stripslashes($data[footer_url]);?>'
          size=40 maxlength=255 class=input style=width:95%;border-color:#b0b0b0> &nbsp;&nbsp;
      </td>
    </tr>
    ...
    <tr height=25 bgcolor=#e0e0e0>
      ...
      <td>&nbsp;&nbsp;
        <textarea name=footer cols=70 rows=10 class=textarea
          style=width:95%;border-color:#b0b0b0><?php echo stripslashes($data[footer]);?></textarea>
      </td>
    </tr>
    ...
    <?php unset($check); if ($data[use_showreply]) {
    $check = 'checked';
} else {
    $check = '';
} ?>
    ...
    <tr height=25 bgcolor=#e0e0e0>
      ...
      <td>&nbsp;&nbsp;
        <input type=text name=pds_ext1
          value='<?php echo stripslashes($data[pds_ext1]);?>' size=50
          maxlength=250 class=input style=width:95%;border-color:#b0b0b0><br>&nbsp;&nbsp; 1번 업로드 가능 확장자 지정 (공백시 검사하지않음.
        쉼표(,)로 구분)
      </td>
    </tr>
    ...
    <tr height=25 bgcolor=#e0e0e0>
      ...
      <td>&nbsp;&nbsp;
        <input type=text name=pds_ext2
          value='<?php echo stripslashes($data[pds_ext2]);?>' size=50
          maxlength=250 class=input style=width:95%;border-color:#b0b0b0><br>&nbsp;&nbsp; 2번 업로드 가능 확장자 지정 (공백시 검사하지않음.
        쉼표(,)로 구분)
      </td>
    </tr>
    ...
    <tr height=25 bgcolor=#e0e0e0>
      ...
      <td>&nbsp;&nbsp;
        <input type=text name=max_upload_size
          value="<?=$data[max_upload_size]?>" size=10 class=input
          style=border-color:#b0b0b0> byte &nbsp;&nbsp; (최고한도 : <?php echo get_cfg_var('upload_max_filesize'); ?>
        byte)
      </td>
    </tr>


    <?php if ($data[use_cart]) {
    $check = 'checked';
} else {
    $check = '';
} ?>
    ...
    <tr height=25 bgcolor=#e0e0e0>
      ...
      <td>&nbsp;&nbsp;
        <textarea name=filter cols=70 rows=6 class=textarea
    ...
    <tr height=25 bgcolor=#e0e0e0>
      ...
      <td>&nbsp;&nbsp;
        <textarea name=avoid_tag cols=70 rows=6 class=textarea
          style=width:95%;border-color:#b0b0b0><?=$data[avoid_tag]?></textarea><br>
    ...
    <tr height=25 bgcolor=#e0e0e0>
      ...
      <td>&nbsp;&nbsp;
        <textarea name=avoid_ip cols=70 rows=4 class=textarea
