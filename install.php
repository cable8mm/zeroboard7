...
<body bgcolor=#000000 text=#ffffff>
		...
		<form name=license>
			<table cellpadding=3 cellspacing=0 width=600 border=0>
				<tr>
					...
					<td><br>
						<img src=images/inst_step1.gif> <textarea cols=90 rows=15 readonly><?php include 'license.txt'; ?></textarea>
						<br>
  ...
  if (!$check) {
      echo"<font color=red>현재 707로 퍼미션이 되어 있지 않습니다. 텔넷이나 FTP에서 퍼미션을 조정하세요.<font><br><br>
      ...
      echo"<br><br><div align=center><table border=0><tr><form method=post action=install1.php onsubmit='return check_submit()'><td align=center height=30><input type=image src=images/inst_b_1.gif border=0 align=absmiddle></td></tr></table>";
  }
?>
					<br>
			</td>
